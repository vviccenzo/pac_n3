...
class ProfBuscarPendentesWidget extends StatefulWidget {
  const ProfBuscarPendentesWidget({Key? key}) : super(key: key);

  @override
  _ProfBuscarPendentesWidgetState createState() =>
      _ProfBuscarPendentesWidgetState();
}

class _ProfBuscarPendentesWidgetState extends State<ProfBuscarPendentesWidget> {
              ...
              StreamBuilder<List<DocumentoFinalRecord>>(
                stream: queryDocumentoFinalRecord(
                  queryBuilder: (documentoFinalRecord) => documentoFinalRecord
                      .where('doc_statusNew', isEqualTo: 'Pendente')
                      .where('doc_nome',
