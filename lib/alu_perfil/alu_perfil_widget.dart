...
class AluPerfilWidget extends StatefulWidget {
  const AluPerfilWidget({
    Key? key,
    this.aluno,
  }) : super(key: key);
  ...
  @override
  _AluPerfilWidgetState createState() => _AluPerfilWidgetState();
}

class _AluPerfilWidgetState extends State<AluPerfilWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AlunoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AlunoRecord> aluPerfilAlunoRecordList = snapshot.data!;
        final aluPerfilAlunoRecord = aluPerfilAlunoRecordList.isNotEmpty
            ? aluPerfilAlunoRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
                        ...
                        child: StreamBuilder<List<DocumentoFinalRecord>>(
                          stream: queryDocumentoFinalRecord(
                            queryBuilder: (documentoFinalRecord) =>
                                documentoFinalRecord.where('user_email',
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<DocumentoFinalRecord>
                                listViewDocumentoFinalRecordList =
                                snapshot.data!;
                            ...
                            return ListView.builder(
                              ...
                              itemCount:
                                  listViewDocumentoFinalRecordList.length,
