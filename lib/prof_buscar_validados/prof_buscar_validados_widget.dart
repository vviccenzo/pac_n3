...
class ProfBuscarValidadosWidget extends StatefulWidget {
  const ProfBuscarValidadosWidget({Key? key}) : super(key: key);

  @override
  _ProfBuscarValidadosWidgetState createState() =>
      _ProfBuscarValidadosWidgetState();
}

class _ProfBuscarValidadosWidgetState extends State<ProfBuscarValidadosWidget> {
                  ...
                  queryBuilder: (documentoFinalRecord) => documentoFinalRecord
                      .where('doc_nome',
                          isEqualTo: textController!.text != ''
                              ? textController!.text
                              : null)
                      .where('doc_statusNew', isEqualTo: 'Aprovar'),
                ),
