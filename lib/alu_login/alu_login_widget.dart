...
class AluLoginWidget extends StatefulWidget {
  const AluLoginWidget({Key? key}) : super(key: key);

  @override
  _AluLoginWidgetState createState() => _AluLoginWidgetState();
}

class _AluLoginWidgetState extends State<AluLoginWidget> {
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          final alunoCreateData =
                                              createAlunoRecordData(
                                            email: emailTextController1!.text,
                                            userName: textController1!.text,
                                            aluCurso: textController2!.text,
                                            aluSenha:
